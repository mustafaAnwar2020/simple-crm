...
Route::middleware('auth:api')->group(function () {
    ...
    Route::get('/clients/show/{client}','App\Http\Controllers\API\ClientsController@index');
    ...
    Route::put('/clients/update/{client}','App\Http\Controllers\API\ClientsController@update');
    ...
    Route::get('/projects/show/{project}','App\Http\Controllers\API\ProjectsController@show');
    Route::post('/projects/create','App\Http\Controllers\API\ProjectsController@store');
    Route::put('/projects/update/{project}','App\Http\Controllers\API\ProjectsController@update');
    Route::delete('/projects/{project}','App\Http\Controllers\API\ProjectsController@destroy');
